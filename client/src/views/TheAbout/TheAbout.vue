      ...
      <div class="about__text">
        ...
        <div class="about__nav">
          <a class="btn btn--big btn--yellow" href="https://bit.ly/crynet-resume" target="_blank">
            <svg width="15" viewBox="0 0 384 512">
              <path
          ...
          <a class="btn btn--big" href="https://github.com/uCryNet" target="_blank">
            <svg width="18" viewBox="0 0 496 512">
              <path
          ...
          <a class="btn btn--big" href="https://telegram.me/ucrynet" target="_blank">
            <svg width="18" viewBox="0 0 496 512">
              <path
